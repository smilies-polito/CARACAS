...
This PoC was originally presented to the IEEE Symposium on Computers and Communications (ISCC) 2024. For citing the paper you can import the following BibTex:

``` Bibtex
@INPROCEEDINGS{10733705,
...
- [Paper on ResearchGate](https://www.researchgate.net/publication/385430424_CARACAS_vehiCular_ArchitectuRe_for_detAiled_Can_Attacks_Simulation)
- [Paper on Porto@IRIS](https://iris.polito.it/handle/11583/2995722)
- [Paper on IEEE Xplore](https://ieeexplore.ieee.org/document/10733705)
- Directly inside [this repository](./paper/TrustAICyberSec-2024_CARACAS_Vehicular-Modular-Architecture-for-detailed-CAN-attacks-Simulation.pdf)
